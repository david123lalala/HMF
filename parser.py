...
def parameter_parser():
    ...
    parser.add_argument('-D', '--dataset',type=str,default='reentrancy',choices=['reentrancy_single',
                                        'reentrancy','reentrancy_base','train_data/timestamp.txt',
                                        'train_data/infinite_loop_1317.txt','train_data/reentrancy_1671.txt',
                                        'timestamp_single','timestamp','timestamp_base',
                                        'loop_single','loop','loop_base'])
    ...
    parser.add_argument('-b', '--batch_size', type=int, default=32, choices=['16','32','64','128'],help='batch size')
